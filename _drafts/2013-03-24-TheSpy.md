...
The address passed to %rdi is where the start function will return to and as such is the location we need to 
be looking at next as this is where the majority of the code for the application is located. If you copy the
address that we will be looking at next and search of it in the functionsHandles text file that we created
earlier you will notice that it is the second function in the list of 4 used by the application.
